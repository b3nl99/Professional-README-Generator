...
const questions = [
    ...
    },
    {
        type: 'input',
        name: 'contributions',
        message: 'What huidelines must others follow in order to contribute?',
    ...
    },
    {
        ...
        validate: askMeInput = () => {
            if (askMeInput) {
                ...
                console.log('Please probide your username so others can reach out to your with questions')
                return false;
            }
        }
    },
